...
bmm150_err_t bmm150_get_trim_data(bmm150_t const* bmm150, bmm150_trim_data_t* data)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_DIG_X1, trim_x1y1, sizeof(trim_x1y1));
    err |= bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_DIG_Z4_LSB, trim_xyz, sizeof(trim_xyz));
    err |= bmm150_bus_read_data(bmm150,
                                BMM150_REG_ADDRESS_DIG_Z2_LSB,
                                trim_xy1xy2,
                                sizeof(trim_xy1xy2));
...
bmm150_err_t bmm150_get_chip_id_reg(bmm150_t const* bmm150, bmm150_chip_id_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_CHIP_ID, &data, sizeof(data));
...
bmm150_err_t bmm150_get_data_x_reg(bmm150_t const* bmm150, bmm150_data_x_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_DATAX_LSB, data, sizeof(data));
...
bmm150_err_t bmm150_get_data_y_reg(bmm150_t const* bmm150, bmm150_data_y_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_DATAY_LSB, data, sizeof(data));
...
bmm150_err_t bmm150_get_data_z_reg(bmm150_t const* bmm150, bmm150_data_z_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_DATAZ_LSB, data, sizeof(data));
...
bmm150_err_t bmm150_get_rhall_reg(bmm150_t const* bmm150, bmm150_rhall_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_RHALL_LSB, data, sizeof(data));
...
bmm150_err_t bmm150_get_int_stat_reg(bmm150_t const* bmm150, bmm150_int_stat_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_INT_STAT, &data, sizeof(data));
...
bmm150_err_t bmm150_get_pwr_rst_reg(bmm150_t const* bmm150, bmm150_pwr_rst_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_PWR_RST, &data, sizeof(data));
...
bmm150_err_t bmm150_set_pwr_rst_reg(bmm150_t const* bmm150, bmm150_pwr_rst_reg_t const* reg)
{
    ...
    err |= bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_PWR_RST, &data, sizeof(data));
...
bmm150_err_t bmm150_get_odr_opmode_reg(bmm150_t const* bmm150, bmm150_opmode_reg_t* reg)
{
    ...
    bmm150_err_t err = bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_OPMODE, &data, sizeof(data));
...
bmm150_err_t bmm150_set_odr_opmode_reg(bmm150_t const* bmm150, bmm150_opmode_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_OPMODE, &data, sizeof(data));
}
...
bmm150_err_t bmm150_get_int_ctrl1_reg(bmm150_t const* bmm150, bmm150_int_ctrl1_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_INT_CTRL1, &data, sizeof(data));
...
bmm150_err_t bmm150_set_int_ctrl1_reg(bmm150_t const* bmm150, bmm150_int_ctrl1_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_INT_CTRL1, &data, sizeof(data));
}
...
bmm150_err_t bmm150_get_int_ctrl2_reg(bmm150_t const* bmm150, bmm150_int_ctrl2_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_INT_CTRL2, &data, sizeof(data));
...
bmm150_err_t bmm150_set_int_ctrl2_reg(bmm150_t const* bmm150, bmm150_int_ctrl2_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_INT_CTRL2, &data, sizeof(data));
}
...
bmm150_err_t bmm150_get_int_low_thresh_reg(bmm150_t const* bmm150, bmm150_int_low_thresh_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_INT_LOW_THRESH, &data, sizeof(data));
                                           ...
                                           bmm150_int_low_thresh_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_INT_LOW_THRESH, &data, sizeof(data));
}
                                            ...
                                            bmm150_int_high_thresh_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_INT_HIGH_THRESH, &data, sizeof(data));
                                            ...
                                            bmm150_int_high_thresh_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_INT_HIGH_THRESH, &data, sizeof(data));
}
...
bmm150_err_t bmm150_get_axis_rep_xy_reg(bmm150_t const* bmm150, bmm150_axis_rep_xy_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_AXIS_REP_XY, &data, sizeof(data));
...
bmm150_err_t bmm150_set_axis_rep_xy_reg(bmm150_t const* bmm150, bmm150_axis_rep_xy_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_AXIS_REP_XY, &data, sizeof(data));
}
...
bmm150_err_t bmm150_get_axis_rep_z_reg(bmm150_t const* bmm150, bmm150_axis_rep_z_reg_t* reg)
{
    ...
    bmm150_err_t err =
        bmm150_bus_read_data(bmm150, BMM150_REG_ADDRESS_AXIS_REP_Z, &data, sizeof(data));
...
bmm150_err_t bmm150_set_axis_rep_z_reg(bmm150_t const* bmm150, bmm150_axis_rep_z_reg_t const* reg)
{
    ...
    return bmm150_bus_write_data(bmm150, BMM150_REG_ADDRESS_AXIS_REP_Z, &data, sizeof(data));
}
